<div class="container-fluid pt-5" id='just-arrived-collection'>
        ...
        <div class="row px-xl-5 pb-3">
           <?php
           /*$Q =
               "SELECT * FROM products WHERE DATE(added) BETWEEN ADDDATE(NOW(),-7) AND NOW() ORDER BY RAND()";*/
            $Q =
               "SELECT * FROM products WHERE DATE(added) BETWEEN ADDDATE(NOW(),-7) AND NOW() LIMIT 8";
            ...
            <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
                <div class="card product-item border-0 mb-4">
                    ...
                    <div class="card-body border-left border-right text-center p-0 pt-4 pb-3">
                        <h6 class="mb-3"><?php echo ucwords($Row['name']); ?></h6>
                        <div class="d-flex justify-content-center">
                            <h6><?php echo $Row["discountedprice"]; ?>
                            </h6><h6 class="text-muted ml-2"><del><?php echo $Row["saleprice"]; ?></del></h6>
                        </div>
                    </div>
