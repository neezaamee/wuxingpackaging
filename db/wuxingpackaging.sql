...
CREATE TABLE `category` (
  ...
  `idstatus` tinyint NOT NULL DEFAULT '6',
...
INSERT INTO `countries` (`id`, `name`, `shortcode`, `status`, `added`, `updated`) VALUES
(1, 'United Arab Emirates', 'UAE', 6, '2024-06-08 12:38:03', '2024-06-08 12:39:26');
...
CREATE TABLE `customers` (
  ...
  `idstate` smallint DEFAULT NULL,
  `idcountry` tinyint DEFAULT NULL,
  `zipcode` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `idstatus` tinyint NOT NULL DEFAULT '6',
...
INSERT INTO `customers` (`id`, `firstname`, `lastname`, `email`, `phone`, `address1`, `address2`, `idcity`, `idstate`, `idcountry`, `zipcode`, `idstatus`, `added`, `updated`) VALUES
(1, 'John', 'Doe', 'example@email.com', 123456789, '123 Street', '123 Street', NULL, 3, NULL, '123', 6, '2024-06-07 22:37:51', NULL),
(2, 'Sylvester', 'Wilder', 'kegugu@mailinator.com', 551234567, '843 Nobel Lane', 'Impedit dicta corpo', NULL, 3, NULL, '58821', 6, '2024-06-08 01:30:28', NULL),
(3, 'Sylvester', 'Wilder', 'kegugu@mailinator.com', 551234567, '843 Nobel Lane', 'Impedit dicta corpo', NULL, 3, NULL, '58821', 6, '2024-06-08 01:30:50', NULL),
(4, 'Caesar', 'Marks', 'ruhifaw@mailinator.com', 553216547, '62 White Cowley Road', 'Fugiat est iusto es', NULL, 4, NULL, '45740', 6, '2024-06-08 01:31:59', NULL),
(5, 'Henry', 'Hawkins', 'verewawuve@mailinator.com', 557654321, '21 Clarendon Court', 'Autem aperiam distin', NULL, 3, NULL, '55691', 6, '2024-06-08 02:25:57', NULL),
(6, 'Maggie', 'Ball', 'cutywe@mailinator.com', 551234567, '170 Nobel Road', 'Nemo voluptatum modi', NULL, 5, NULL, '12670', 6, '2024-06-08 02:27:28', NULL),
(7, 'Gay', 'Phillips', 'pipyf@mailinator.com', 551234567, '63 West Oak Court', 'Consequuntur sed inc', NULL, 5, NULL, '95533', 6, '2024-06-08 14:53:14', NULL),
(8, 'Boris', 'Reed', 'nejef@mailinator.com', 551234567, '40 Milton Lane', 'Corporis sunt quam a', NULL, 1, NULL, '62062', 6, '2024-06-08 15:42:02', NULL);
...
--
-- Table structure for table `orderitemsdetail`
--

CREATE TABLE `orderitemsdetail` (
  `id` int NOT NULL,
...
--
-- Dumping data for table `orderitemsdetail`
--

INSERT INTO `orderitemsdetail` (`id`, `idorder`, `idproduct`, `quantity`, `price`, `added`, `addedby`, `updated`, `updatedby`, `status`) VALUES
(1, 2, 22, 1, 15.75, '2024-06-08 02:27:28', NULL, NULL, NULL, 6),
(2, 3, 1, 5, 31.5, '2024-06-08 14:53:14', NULL, NULL, NULL, 6),
(3, 3, 2, 4, 27.75, '2024-06-08 14:53:14', NULL, NULL, NULL, 6),
(4, 3, 33, 5, 73.5, '2024-06-08 14:53:14', NULL, NULL, NULL, 6),
(5, 4, 33, 4, 73.5, '2024-06-08 15:42:02', NULL, NULL, NULL, 6);
...
INSERT INTO `orders` (`id`, `idcustomer`, `subtotal`, `shippingfee`, `discount`, `grandtotal`, `note`, `status`, `added`, `updated`, `addedby`, `updatedby`) VALUES
(1, 5, 15.75, 10, 0, 25.75, NULL, 12, '2024-06-08 02:25:57', NULL, NULL, NULL),
(2, 6, 15.75, 10, 0, 25.75, NULL, 12, '2024-06-08 02:27:28', NULL, NULL, NULL),
(3, 7, 636, 10, 0, 646, NULL, 12, '2024-06-08 14:53:14', NULL, NULL, NULL),
(4, 8, 294, 10, 0, 304, 'Additional Description or Note', 12, '2024-06-08 15:42:02', NULL, NULL, NULL);
...
INSERT INTO `states` (`id`, `name`, `idcountry`, `status`, `added`, `updated`) VALUES
(1, 'Dubai', 1, 6, '2024-06-07 20:33:00', '2024-06-07 20:33:32'),
(2, 'Sharjah', 1, 6, '2024-06-07 20:33:00', '2024-06-07 20:33:35'),
(3, 'Ajman', 1, 6, '2024-06-07 20:33:00', '2024-06-07 20:33:37'),
(4, 'Umm Al Quwain', 1, 6, '2024-06-07 20:33:00', '2024-06-07 20:33:40'),
(5, 'Ras Al Khaimah', 1, 6, '2024-06-07 20:33:00', '2024-06-07 20:33:42'),
(6, 'Fujairah', 1, 6, '2024-06-07 20:33:00', '2024-06-07 20:33:44');
...
(8, 'pending', '2024-05-28 18:19:51', NULL),
(9, 'delivered', '2024-05-28 18:20:18', NULL),
(10, 'completed', '2024-05-28 18:20:35', NULL),
(11, 'Pending', '2024-06-08 01:57:28', NULL),
(12, 'Processing', '2024-06-08 01:57:28', NULL),
(13, 'Shipped', '2024-06-08 01:57:28', NULL),
(14, 'Delivered', '2024-06-08 01:57:28', NULL),
(15, 'Cancelled', '2024-06-08 01:57:28', NULL),
(16, 'Refunded', '2024-06-08 01:57:28', NULL),
(17, 'On Hold', '2024-06-08 01:57:28', NULL);
...
CREATE TABLE `subcategory` (
  ...
  `idsubcategory` int DEFAULT NULL,
  `idcategory` int DEFAULT NULL,
  `idstatus` int NOT NULL DEFAULT '6',
  `added` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `updated` datetime DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
(3, 'pack', 1, '2024-05-26 17:06:51', '2024-05-28 18:18:03');
...
ALTER TABLE `customers`
  ADD PRIMARY KEY (`id`),
  ADD KEY `IDcityANDcities` (`idcity`);
...
ALTER TABLE `images`
  ADD PRIMARY KEY (`id`),
  ADD KEY `imgprodct` (`idproduct`),
  ADD KEY `imgsubcat` (`idsubcategory`);

--
-- Indexes for table `orderitemsdetail`
--
ALTER TABLE `orderitemsdetail`
  ADD PRIMARY KEY (`id`);
...
ALTER TABLE `orders`
  ADD PRIMARY KEY (`id`),
  ADD KEY `IDcustomerANDCustomer` (`idcustomer`);
...
ALTER TABLE `subcategory`
  ADD PRIMARY KEY (`id`),
  ADD KEY `IDsubcategoryAndSubcategory` (`idsubcategory`),
  ADD KEY `IDcategoryAndCategory` (`idcategory`);
...
ALTER TABLE `variations`
  ADD PRIMARY KEY (`id`),
  ADD KEY `IDvariationtypeAndVariationtypes` (`idvariationtypes`),
  ADD KEY `IDproductAndProduct` (`idproduct`);
...
--
-- AUTO_INCREMENT for table `orderitemsdetail`
--
ALTER TABLE `orderitemsdetail`
  MODIFY `id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `customers`
  ADD CONSTRAINT `IDcityANDcities` FOREIGN KEY (`idcity`) REFERENCES `cities` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT;

--
-- Constraints for table `images`
--
ALTER TABLE `images`
  ADD CONSTRAINT `imgprodct` FOREIGN KEY (`idproduct`) REFERENCES `products` (`id`) ON DELETE SET NULL ON UPDATE SET NULL,
  ADD CONSTRAINT `imgsubcat` FOREIGN KEY (`idsubcategory`) REFERENCES `subcategory` (`id`) ON DELETE SET NULL ON UPDATE SET NULL;

--
-- Constraints for table `orders`
--
ALTER TABLE `orders`
  ADD CONSTRAINT `IDcustomerANDCustomer` FOREIGN KEY (`idcustomer`) REFERENCES `customers` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT;

--
-- Constraints for table `subcategory`
--
ALTER TABLE `subcategory`
  ADD CONSTRAINT `IDcategoryAndCategory` FOREIGN KEY (`idcategory`) REFERENCES `category` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  ADD CONSTRAINT `IDsubcategoryAndSubcategory` FOREIGN KEY (`idsubcategory`) REFERENCES `subcategory` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `variations`
--
ALTER TABLE `variations`
  ADD CONSTRAINT `IDproductAndProduct` FOREIGN KEY (`idproduct`) REFERENCES `products` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `IDvariationtypeAndVariationtypes` FOREIGN KEY (`idvariationtypes`) REFERENCES `variationtypes` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT;
COMMIT;
